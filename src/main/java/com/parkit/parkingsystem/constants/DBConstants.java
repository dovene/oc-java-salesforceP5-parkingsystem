...
public class DBConstants {
    ...
    public static final String GET_TICKET_BY_REGISTRATION_NUMBER = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? ";
